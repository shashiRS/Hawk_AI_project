...
def youtube_search(options):
  ...
  video_response = youtube.videos().list(
    id=video_ids,
    part='snippet, recordingDetails,contentDetails,statistics'
  ).execute()
...
if __name__ == '__main__':
  ...
  parser.add_argument('--location', help='Location', default='12.9716,77.5946')
  parser.add_argument('--location-radius', help='Location radius', default='25km')
